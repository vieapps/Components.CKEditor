# CKEditor5 custom build with integration of custom link/media selectors

This repository presents a CKEditor5 with integration of custom link/media selectors, and the CKFinder/CKFinderAdapter also removed.
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `4yaeu8p9k87d-i9tx57pekm1t`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
