...
import ViewPopup from './bookmark.ui.popup.view';
import EditPopup from './bookmark.ui.popup.edit';
...
export default class LinkUI extends Plugin {
	...
	_showUI() {
		...
		function showEditPopup(linkUI) {
			...
			// https://ckeditor.com/docs/ckeditor5/latest/api/module_ui_panel_balloon_contextualballoon-ContextualBalloon.html#function-add
			linkUI._balloon.add({
